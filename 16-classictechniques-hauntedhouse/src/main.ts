...
roof.rotation.y = Math.PI * 0.25; // rotate roof by 45 degrees
house.add(roof);
...
const door = new THREE.Mesh(
	...
	new THREE.MeshStandardMaterial({
		...
		transparent: true,	//if you have transparency in mesh, you need to activate transparent = true
...
//restrict area graves can be placed by using circle area where they can be placed.
//first place grave on the circumference of the circle, then move then closer or further.
