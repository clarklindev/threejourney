...
const particleTexture = textureLoader.load("/textures/particles/penis.png");
...
const colors = new Float32Array(count * 3);	//3 values for storing r,g,b in array
...
particlesGeometry.setAttribute(
	"position",
	new THREE.BufferAttribute(positions, 3)	//3 values for each particle
);
